...
<div id="box-title">BIDANG <?php echo $bidang; ?></div>
	...
	<div id="dashboard-icon">
		<a href="<?php echo base_url(); ?>web/berita_panitia/get/<?php echo $id_super_bidang; ?>">
	...
	<div id="dashboard-icon">
		<a href="<?php echo base_url(); ?>web/pengumuman_panitia/get/<?php echo $id_super_bidang; ?>">
	...
	<div id="dashboard-icon">
		<a href="<?php echo base_url(); ?>web/agenda_panitia/get/<?php echo $id_super_bidang; ?>">
	...
	<div id="dashboard-icon">
		<a href="<?php echo base_url(); ?>web/list_download_panitia/get/<?php echo $id_super_bidang; ?>">
