...
<body>
				...
				<div class="nav-collapse collapse">
					...
					<div class="btn-group pull-right">
				        ...
				        <ul class="dropdown-menu">
			          		<li><a href="<?php echo base_url(); ?>panlih/profil"><i class="icon-map-marker"></i> Profil User</a></li>
			          		<li><a href="<?php echo base_url(); ?>panlih/password"><i class="icon-folder-open"></i> Password User</a></li>
	 		 				<li class="divider"></li>
					...
					<div class="btn-group pull-right">
							<a class="btn" href="<?php echo base_url(); ?>panlih">
	...
	<aside class="sidebar">
		<ul class="nav nav-tabs nav-stacked">
			...
			<li class="<?php echo $aktif_formatur_cabang; ?>">
				<a href="<?php echo base_url(); ?>panlih/formatur_cabang">
				<?php if($_SESSION['count_formatur_cabang']!=0){ ?>
					<span class="badge badge-important m-badge-notification"><?php echo $_SESSION['count_formatur_cabang']; ?></span>
				<?php } ?>
					<div>
						<div class="ico">
							<img src="<?php echo base_url(); ?>asset/admin/images/formatur.png" height="50px" width="50px">
						</div>
						<div class="title">
							FORMATUR CABANG
						</div>
