...
<link rel="shortcut icon" href="<?php echo base_url(); ?>asset/theme/<?php echo $_SESSION['site_theme']; ?>/images/favicon.png">
...
<div id="inner-main-menu">
    ...
    <a class="pic" href="http://www.facebook.com/">
        <img class="image1" src="<?php echo base_url(); ?>asset/theme/blue-clouds/images/fb_hover.png" width="25,962" />
        <img class="image2" src="<?php echo base_url(); ?>asset/theme/blue-clouds/images/fb.png" width="25,962" /></a>
    <a class="pic" href="http://immsetengahabad.blogspot.com/">
        <img class="image1" src="<?php echo base_url(); ?>asset/theme/blue-clouds/images/immsetab.png" width="25,962" />
        <img class="image2" src="<?php echo base_url(); ?>asset/theme/blue-clouds/images/immsetab_hover.png" width="25,962" /></a>
        </div>
