		...
		<div class="container-fluid">
			<section>
				...
				<option value=""></option>
					...
					{
						if($b['id_cabang_profil']==$id_cabang)
						{
					?>
						<option value="<?php echo $b['id_cabang_profil']; ?>" selected="selected"><?php echo $b['nama_cabang']; ?></option>
						<?php
						}
						else
						{
						?>
						<option value="<?php echo $b['id_cabang_profil']; ?>"><?php echo $b['nama_cabang']; ?></option>
						<?php
						}
					}
					?>
